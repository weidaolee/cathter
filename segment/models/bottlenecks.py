...
class ResNestBottleneck(nn.Module):
    ...
    def __init__(
        ...
        self.act1 = act_layer(group_width, init=0.01)
        ...
        if self.radix >= 1:
            ...
            self.act2 = act_layer(group_width, init=0.01)
        self.avd_last = nn.AvgPool2d(
            3, avd_stride,
            padding=1) if avd_stride > 0 and not avd_first else None
        ...
        self.act3 = act_layer(planes * 4, init=0.01)
...
def resnest14d(pretrained=False, **kwargs):
    ...
    """
    model_kwargs = dict(block=ResNestBottleneck,
                        layers=[1, 1, 1, 1],
                        stem_type='deep',
                        stem_width=32,
                        avg_down=True,
...
def resnest101e(pretrained=False, **kwargs):
    ...
    model_kwargs = dict(block=ResNestBottleneck,
                        ...
                        block_args=dict(radix=2, avd=True, avd_first=False),
                        **kwargs)
    return _create_resnest('resnest101e',
...
def resnest200e(pretrained=False, **kwargs):
    ...
    model_kwargs = dict(block=ResNestBottleneck,
                        ...
                        block_args=dict(radix=2, avd=True, avd_first=False),
                        **kwargs)
    return _create_resnest('resnest200e',
                           pretrained=pretrained,
                           **model_kwargs)
...
def resnest269e(pretrained=False, **kwargs):
    ...
    model_kwargs = dict(block=ResNestBottleneck,
                        ...
                        block_args=dict(radix=2, avd=True, avd_first=False),
                        **kwargs)
    return _create_resnest('resnest269e',
                           pretrained=pretrained,
                           **model_kwargs)
...
def resnest50d_4s2x40d(pretrained=False, **kwargs):
    ...
    model_kwargs = dict(block=ResNestBottleneck,
                        ...
                        **kwargs)
    return _create_resnest('resnest50d_4s2x40d',
                           pretrained=pretrained,
                           **model_kwargs)
...
def resnest50d_1s4x24d(pretrained=False, **kwargs):
    ...
    model_kwargs = dict(block=ResNestBottleneck,
                        ...
                        **kwargs)
    return _create_resnest('resnest50d_1s4x24d',
                           pretrained=pretrained,
                           **model_kwargs)
